# HeritageLibraryCatalog

Build an Heritage Library Catalog Project.

## Source Code

```js
/*
    This workshop is about build a heritage library catalog system. You will parse raw book data, search and group entries, validate data quality, and export results to different formats.
*/
...
![Image](https://github.com/user-attachments/assets/e89414ba-dd93-4750-8bd5-3001dda716d7)
